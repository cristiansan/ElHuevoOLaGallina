...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/app.eggorchicken.eggorchicken/databases/";

    private static String DB_NAME = "eggorchiken.db";
...
//        Cursor cursor = myDataBase.query("main", new String[] { "id", "qustion" }, null, null, null, null, null);
        Cursor cursor = myDataBase.rawQuery("SELECT * FROM main ORDER BY RANDOM() LIMIT 1", null);
        cursor.moveToFirst();
